  ...
  return (
    <nav className="fixed bottom-4 left-1/2 z-50 w-[calc(100%-32px)] max-w-md -translate-x-1/2 rounded-3xl bg-white px-3 py-2 shadow-[0_8px_30px_rgba(15,23,42,0.14)] ring-1 ring-slate-100">
      <div className="flex items-center">
        ...
        <div className="ml-1 flex items-center pl-1 pr-1">
          <button
            type="button"
            onClick={() =>
              setLanguage(
            ...
            className="flex items-center gap-1 rounded-xl px-2 py-2 text-[11px] font-bold text-slate-600 transition hover:bg-slate-50"
            aria-label="Change language"
          >
            <span
              className={
                language === "en"
                  ? "rounded-lg bg-[#DDF5F7] px-2 py-1 text-[#149EAF]"
                  : "px-1"
              }
            >
              EN
