      ...
      <section className="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-8">
        ...
        {featured.length > 0 && (
          <>
            ...
            <section className="mt-5 grid gap-5 sm:mt-8 sm:gap-7 md:grid-cols-2 xl:grid-cols-3">
        ...
        {events.length === 0 ? (
          ...
          <section className="mt-6 grid gap-5 sm:mt-8 sm:gap-7 md:grid-cols-2 xl:grid-cols-3">
